...
/* textzre object stuff on ARB is different from EXT stuff, ARB does not take the texture type, because creates texture sets this */
/* Texture object functions */
...
#if PTRDIFF_MAX == INT_MAX
            RemapGLName( glMapNamedBufferRange ) = RemapGLName( glNamedCopyBufferSubDataEXT );
#else
